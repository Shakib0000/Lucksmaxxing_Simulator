...
public class Rarities {
    ...
    public Rarities(int luck) {
        ...
        rarities.add(new Rarity(388, 180, "Diamond", new Color(185, 242, 255), new Font("Century Schoolbook", Font.PLAIN, 40), 60));
        rarities.add(new Rarity(390, 180, "Emerald", new Color(20, 201, 81), new Font("Century Schoolbook", Font.PLAIN, 40), 105));
        rarities.add(new Rarity(417, 180, "Topaz", new Color(255, 192, 103), new Font("Century Schoolbook", Font.PLAIN, 40), 125));
        rarities.add(new Rarity(391, 180, "Sapphire", new Color(15,82,186), new Font("Century Schoolbook", Font.PLAIN, 40), 144));
        rarities.add(new Rarity(429, 180, "Ruby", new Color(	224, 17, 95), new Font("Century Schoolbook", Font.PLAIN, 40), 188));
        rarities.add(new Rarity(386, 180, "Amethyst", new Color(125, 0, 255), new Font("Century Schoolbook", Font.PLAIN, 40), 220));
        rarities.add(new Rarity(362, 180, "Aquamarine", new Color(	127, 255, 212), new Font("Century Schoolbook", Font.PLAIN, 40), 260));
        rarities.add(new Rarity(432, 180, "Jade", new Color(3, 248, 162), new Font("Century Schoolbook", Font.PLAIN, 40), 310));
        rarities.add(new Rarity(429, 180, "Opal", new Color(246, 149, 226), new Font("Century Schoolbook", Font.PLAIN, 40), 414));
        rarities.add(new Rarity(389, 180, "Platinum", new Color(229,228,226), new Font("Century Schoolbook", Font.PLAIN, 40), 463));
        rarities.add(new Rarity(387, 180, "Titanium", new Color(121, 121, 130), new Font("Century Schoolbook", Font.PLAIN, 40), 635));
        rarities.add(new Rarity(376, 180, "Moonstone", new Color(190, 211, 255), new Font("Century Schoolbook", Font.PLAIN, 40), 1499));
    }
